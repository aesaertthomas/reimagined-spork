class Hotelguest:
    ...
    def __init__(self, parlastname: str, parfirstname: str, parbalance: int = 0, par_checked_in: bool = False) -> None:
    ...
    def __eq__(self, other) -> bool:
        if not isinstance(other, Hotelguest):
            raise TypeError("Your second object is not of the type Hotelguest")
